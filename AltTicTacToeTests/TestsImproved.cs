...
public class ImprovedTests: BaseTest
{
    ...
    public void TestDrawResult()
    {
        ...
        AltObject Slot8 = helperMethods.GetSlotByNumber("8");
        Assert.NotNull(Slot8);
        altDriver.Click(Slot8.GetScreenPosition());
        ...
        AltObject Slot4 = helperMethods.GetSlotByNumber("4");
        Assert.NotNull(Slot4);
        altDriver.Click(Slot4.GetScreenPosition());
        ...
        AltObject WinInfo = helperMethods.WinInfo;
        Assert.NotNull(WinInfo);
        Assert.That(WinInfo.GetText(), Is.EqualTo("It's a draw!"));
    }
    [Test]
